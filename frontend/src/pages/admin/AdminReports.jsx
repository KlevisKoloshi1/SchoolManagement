...
import { getClasses, getClassStudents, getPerformanceReport, exportPerformanceReportPdf } from '../../api/admin'
    ...
    <div className="space-y-8 animate-fade-in">
      <div className="text-center sm:text-left">
        ...
        <div className="text-text-secondary max-w-2xl">
          {t('reports.performanceReport')} — {t('reports.selectClass')} → {t('reports.selectStudent')}
        </div>
      </div>
      ...
      <Card title={t('reports.performanceReport')} className="max-w-6xl">
        <div className="flex flex-wrap gap-4 mb-6">
          <Select
            ...
            options={[{ value: '', label: t('reports.selectClassFirst') }, ...(classes.map((c) => ({ value: String(c.id), label: c.name })))]}
